...
{
    public class Under18s
    {
        //This class is our Under18s entity design. It is used by the DataContext class to design the Under 18s squad table for the database
        ...
        public string? Consent { get; set; } // string property to store the players choice of consent - YES or NO
